...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_demo1.cpp, i8* null }]
...
define dso_local i32 @main() local_unnamed_addr #3 {
  %1 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* nonnull dereferenceable(272) @_ZSt4cout, i8* nonnull getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i64 13)
  %2 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !tbaa !2
  ...
  %9 = load %"class.std::ctype"*, %"class.std::ctype"** %8, align 8, !tbaa !5
...
; <label>:19:                                     ; preds = %12
  ...
  %21 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %20, align 8, !tbaa !2
  ...
  %24 = tail call signext i8 %23(%"class.std::ctype"* nonnull %9, i8 signext 10)
  br label %25

; <label>:25:                                     ; preds = %16, %19
  %26 = phi i8 [ %18, %16 ], [ %24, %19 ]
  %27 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* nonnull @_ZSt4cout, i8 signext %26)
...
define internal void @_GLOBAL__sub_I_demo1.cpp() #5 section ".text.startup" {
